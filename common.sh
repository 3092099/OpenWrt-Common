#!/bin/bash
# https://github.com/3092099/AutoBuild-OpenWrt
# common Module by 3092099
...
function Diy_update() {
bash <(curl -fsSL https://raw.githubusercontent.com/3092099/OpenWrt-Common/main/custom/ubuntu.sh)
if [[ $? -ne 0 ]];then
...
master)
  sed -i '/DISTRIB_RECOGNIZE/d' "${REPAIR_PATH}"
  echo -e "\nDISTRIB_RECOGNIZE='18'" >> "${REPAIR_PATH}" && sed -i '/^\s*$/d' "${REPAIR_PATH}"
  curl -fsSL https://raw.githubusercontent.com/3092099/OpenWrt-Common/main/LIENOL/master/boots > ${HOME_PATH}/feeds/packages/libs/boost/Makefile
...
21.02)
  ...
  bash -c "$(curl -fsSL https://raw.githubusercontent.com/3092099/OpenWrt-Common/main/LIENOL/19.07/package/kernel/linux/modules/netsupport.sh)"
...
19.07)
  ...
  rm -rf ${HOME_PATH}/feeds/packages/libs/libcap && svn export https://github.com/3092099/OpenWrt-Common/trunk/LIENOL/19.07/feeds/packages/libs/libcap ${HOME_PATH}/feeds/packages/libs/libcap
  rm -rf ${HOME_PATH}/package/libs/libpcap && svn export https://github.com/3092099/OpenWrt-Common/trunk/LIENOL/19.07/package/libs/libpcap ${HOME_PATH}/package/libs/libpcap
...
master)
  ...
  svn export https://github.com/3092099/OpenWrt-Common/trunk/IMMORTALWRT/default-settings  ${HOME_PATH}/package/emortal/default-settings > /dev/null 2>&1
...
svn export https://github.com/3092099/OpenWrt-Common/trunk/OFFICIAL/default-settings ${HOME_PATH}/package/default-settings > /dev/null 2>&1
...
if [[ "${REPO_BRANCH}" = "openwrt-21.02" ]]; then
  ...
  rm -rf ${HOME_PATH}/feeds/packages/devel/packr && svn export https://github.com/3092099/OpenWrt-Common/trunk/OFFICIAL/1907/packr ${HOME_PATH}/feeds/packages/devel/packr
  bash -c "$(curl -fsSL https://raw.githubusercontent.com/3092099/OpenWrt-Common/main/LIENOL/19.07/package/kernel/linux/modules/netsupport.sh)"
  rm -rf ${HOME_PATH}/feeds/packages/libs/libcap && svn export https://github.com/3092099/OpenWrt-Common/trunk/LIENOL/19.07/feeds/packages/libs/libcap ${HOME_PATH}/feeds/packages/libs/libcap
  rm -rf ${HOME_PATH}/package/libs/libpcap && svn export https://github.com/3092099/OpenWrt-Common/trunk/LIENOL/19.07/package/libs/libpcap ${HOME_PATH}/package/libs/libpcap
  rm -rf ${HOME_PATH}/feeds/packages/lang/golang && svn export https://github.com/coolsnowwolf/packages/trunk/lang/golang ${HOME_PATH}/feeds/packages/lang/golang
...
if [[ -f "${ttydjson}" ]]; then
  curl -fsSL https://raw.githubusercontent.com/3092099/OpenWrt-Common/main/IMMORTALWRT/ttyd/luci-app-ttyd.json -o "${ttydjson}"
fi
...
if [[ ! "${weizhicpu}" == "1" ]] && [[ "${OpenClash_Core}" == "1" ]] && [[ `grep -c "CONFIG_PACKAGE_luci-app-openclash=y" ${HOME_PATH}/.config` -eq '1' ]]; then
  ...
  if [[ "${Archclash}" == "linux-amd64" ]]; then
    ...
    if [[ $? -ne 0 ]];then
      wget -q https://github.com/3092099/OpenWrt-Common/releases/download/API/premium.api -O premium.api
    fi
